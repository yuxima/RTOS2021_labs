...
void pwm_0(void* argument);
void pwm_8(void* argument);
...
int main(void)
{
  ...
  osThreadNew(pwm_0, GPIOA, NULL);
	osThreadNew(pwm_0, GPIOB, NULL);
	osThreadNew(pwm_8, GPIOA, NULL);
	osThreadNew(pwm_8, GPIOB, NULL);
